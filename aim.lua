...
        if player ~= LocalPlayer 和 player.Character then
            local skip = false
            
...
            local distSq = diff.X*diff.X + diff.Y*diff.Y + diff.Z*diff.Z
            if distSq <= (main.maxDistance * main.maxDistance) 键，然后
                return {
